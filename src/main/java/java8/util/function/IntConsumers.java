 ...
 * {@link IntConsumer} interface. 
 */
public final class IntConsumers {
    /**
     * Returns a composed {@code IntConsumer} that performs, in sequence, the {@code this_}
     ...
     * @return a composed {@code IntConsumer} that performs in sequence the {@code this_}
