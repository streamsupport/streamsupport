 ...
 * {@link BiConsumer} interface. 
 */
public final class BiConsumers {
    /**
     * Returns a composed {@code BiConsumer} that performs, in sequence, {@code this_}
     ...
     * @return a composed {@code BiConsumer} that performs in sequence the {@code this_}
