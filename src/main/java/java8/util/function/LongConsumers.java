 ...
 * {@link LongConsumer} interface. 
 */
public final class LongConsumers {
    /**
     * Returns a composed {@code LongConsumer} that performs, in sequence, the {@code this_}
     ...
     * @return a composed {@code LongConsumer} that performs in sequence the {@code this_}
