        ...
        final void execLocalTasks() {
            ...
            if (b - (s = top - 1) <= 0 && a != null &&
                ...
                if ((config & FIFO_QUEUE) == 0) {
                    for (ForkJoinTask<?> t;;) {
                        if ((t = (ForkJoinTask<?>) getAndSetObject
...
//                    U.getAndAddLong(this, CTL, AC_UNIT);
                    do {
                    } while (!U.compareAndSwapLong(this, CTL, ctrl = ctl, ctrl
                            + AC_UNIT));
                }
            }
    ...
    final void externalPush(ForkJoinTask<?> task) {
        ...
        if ((ws = workQueues) != null && (m = (ws.length - 1)) >= 0 &&
            ...
            if ((a = q.array) != null &&
                ...
                // SZ : 2015-04-23
                // Hotfix for ticket #58 (JDK-8078490) bug
//                U.putOrderedInt(q, QLOCK, 0); // TODO
                U.putIntVolatile(q, QLOCK, 0); // TODO
...
//                        U.getAndAddLong(p, CTL, AC_UNIT);
                        do {
                        } while (!U.compareAndSwapLong(p, CTL, ctrl = p.ctl,
                                ctrl + AC_UNIT));
                    }
                    break;
                }
