 ...
 * methods they are protecting.  They are <b>not reentrant</b>, so locked
 ...
 * @author Doug Lea
 */
// revision 1.35 from 2015-02-17
// http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/main/java/util/concurrent/locks/StampedLock.java?revision=1.35
public class StampedLock implements java.io.Serializable {
        ...
        for (int spins = -1;;) {
            ...
            if ((h = whead) == p) {
                ...
                for (int k = spins;;) { // spin at head
                    ...
                    else if (nextSecondarySeed() >= 0 && --k <= 0)
                        break;
                }
            }
    ...
    private static final ThreadLocal<SeedHolder> localSeeds = new ThreadLocal<SeedHolder>() {
        @Override
        protected SeedHolder initialValue() {
            return new SeedHolder();
        }
    };
