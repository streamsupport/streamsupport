...
public class DoubleStreamTestDataProvider {
...

        {
            ...
            for (Object[] data : arrays) {
                ...
                spliterators.add(splitDescr("Arrays.s(array):" + name,
                                            () -> java8.util.J8Arrays.spliterator(doubles)));
                spliterators.add(splitDescr("Arrays.s(array,o,l):" + name,
                                            () -> java8.util.J8Arrays.spliterator(doubles, 0, doubles.length / 2)));
    ...
    static <T> Object[] splitDescr(String description, Supplier<java8.util.Spliterator.OfDouble> s) {
