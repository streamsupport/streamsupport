...
public class AndroidHashMap<K, V> extends AbstractMap<K, V> implements Cloneable, Serializable {
    ...
    public AndroidHashMap(int capacity) {
        ...
        if (capacity < MINIMUM_CAPACITY) {
            ...
            capacity = AndroidCollections.roundUpToPowerOfTwo(capacity);
        }
        makeTable(capacity);
    }
    ...
    public V get(Object key) {
        ...
        int hash = AndroidCollections.secondaryHash(key);
    ...
    private void ensureCapacity(int numMappings) {
        int newCapacity = AndroidCollections.roundUpToPowerOfTwo(capacityForInitSize(numMappings));
