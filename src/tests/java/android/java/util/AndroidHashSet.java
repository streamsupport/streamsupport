 ...
 */
public class AndroidHashSet<E> extends AbstractSet<E> implements Set<E>, Cloneable,
        Serializable {

    private static final long serialVersionUID = -5024744406713321676L;

    transient AndroidHashMap<E, AndroidHashSet<E>> backingMap;

    /**
     * Constructs a new empty instance of {@code HashSet}.
     */
    public AndroidHashSet() {
        this(new AndroidHashMap<E, AndroidHashSet<E>>());
    }
     ...
     */
    public AndroidHashSet(int capacity) {
        this(new AndroidHashMap<E, AndroidHashSet<E>>(capacity));
    }
     ...
     */
    public AndroidHashSet(int capacity, float loadFactor) {
        this(new AndroidHashMap<E, AndroidHashSet<E>>(capacity, loadFactor));
    }
     ...
     */
    public AndroidHashSet(Collection<? extends E> collection) {
        this(new AndroidHashMap<E, AndroidHashSet<E>>(collection.size() < 6 ? 11 : collection
                .size() * 2));
        for (E e : collection) {
            add(e);
        }
    ...
    AndroidHashSet(AndroidHashMap<E, AndroidHashSet<E>> backingMap) {
    ...
    public Object clone() {
        try {
            AndroidHashSet<E> clone = (AndroidHashSet<E>) super.clone();
            clone.backingMap = (AndroidHashMap<E, AndroidHashSet<E>>) backingMap.clone();
            return clone;
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
        ...
        stream.writeFloat(AndroidHashMap.DEFAULT_LOAD_FACTOR);
    ...
    AndroidHashMap<E, AndroidHashSet<E>> createBackingMap(int capacity, float loadFactor) {
        return new AndroidHashMap<E, AndroidHashSet<E>>(capacity, loadFactor);
    }
}
