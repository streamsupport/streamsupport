...
import static java8.util.stream.LambdaTestHelpers.dpFalse;
import static java8.util.stream.LambdaTestHelpers.dpOdd;
import static java8.util.stream.LambdaTestHelpers.dpTrue;
import static java8.util.stream.LambdaTestHelpers.ipEven;
import static java8.util.stream.LambdaTestHelpers.ipFalse;
import static java8.util.stream.LambdaTestHelpers.ipOdd;
import static java8.util.stream.LambdaTestHelpers.ipTrue;
import static java8.util.stream.LambdaTestHelpers.lpEven;
import static java8.util.stream.LambdaTestHelpers.lpFalse;
import static java8.util.stream.LambdaTestHelpers.lpOdd;
import static java8.util.stream.LambdaTestHelpers.lpTrue;
import static java8.util.stream.LambdaTestHelpers.pEven;
import static java8.util.stream.LambdaTestHelpers.pFalse;
import static java8.util.stream.LambdaTestHelpers.pOdd;
import static java8.util.stream.LambdaTestHelpers.pTrue;
