...
import java8.util.stream.DoubleStreamTestScenario;
import java8.util.stream.IntStream;
import java8.util.stream.IntStreamTestScenario;
...
import static java8.util.stream.LambdaTestHelpers.assertUnique;
